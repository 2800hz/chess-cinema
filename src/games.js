export const GAMES = [
  {
    ...
    description:"One of the most celebrated games. Morphy sacrifices for a mating net.",
  ...
  },
  {
    ...
    year:"1851",
    event:"London",
    description:"Romantic sacrifices culminating in mate.",
  ...
  },
  {
    ...
    year:"1852",
    event:"Berlin (casual)",
    description:"Attritional attack with a stunning finish.",
